                ...
                <div class="col-md-12">
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <h3 class="panel-title">ADD INDUSTRY :</h3>
                            <!-- <span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i></span> -->
                        </div>
                        <div class="panel-body">
                            <form name="myForm" method="POST" action="execute/add_industry_execute.php" enctype="multipart/form-data" autocomplete="off">
                                <div class="card-body col-md-offset-1" align="left">
                                    <div class="form-group row">                                        
                                        <div class="col-md-12">
                                            <!-- <label for="exhibitor_name" class="text-primary">EXHIBITOR NAME:</label> -->
                                            <input type="text" id="industry_name" style="text-transform: uppercase" class="form-control" name="industry_name" placeholder="Add industry name here! ">
                                        </div>
                                    </div>
...
<!--                             <h3 class="panel-title">SELECTED TRACKS</h3>
                        ...
                        <div class="panel-body">
                            ...
                            <?php include 'parts/data-table-industry.php';?>
