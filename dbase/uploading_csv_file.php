                ...
                <div class="col-md-12">
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <h3 class="panel-title">IMPORT ASSOCIATION DATA -- CSV FORMAT</h3>
                        </div>
                        <div class="panel-body">
                                ...
                                <div class="col-md-12" id="importFrm" style="display: none;">
                                    <form action="importDays_data.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                             <br>
                                            <label for="exhibitor" class="text-primary">ASSOCIATION:</label>
                                        ...
                                        <div class="col-md-6">
                                             <br>
                                            <label for="exhibitor" class="text-primary">INDUSTRIES:</label>
                                            <select name="exhibitor" class="form-control" id="exhibitor">
                                                <option selected>Choose...</option>
                                                <?php 
