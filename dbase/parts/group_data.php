...
$registered_delegate_qry = "SELECT ID, COMPANY, FULLNAME, JOBTITLE, STATUS,AMOUNT,COUNT_TRACK ,DATE_FORMAT(DATE_CREATED, '%b %d, %Y') AS DATECREATED FROM group_request";
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                     <h1>GROUP<span class="table-project-n">&nbsp;PACKAGE</span> LIST</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead class="bg-primary  text-dark text-uppercase">
                                            <tr>
                                                ...
                                                <th data-field="tracks" data-editable="false">track qty</th>
                                        ...
                                        <tbody>
                                            ...
                                            while ($registered_row = $registered_delegate_result->fetch_assoc()) {
                                                ...
                                                $name = str_replace('\\', '', $registered_row['FULLNAME']);
                                                $stat = $registered_row['STATUS'];
                                                $amount = number_format($registered_row['AMOUNT'], 2);
                                                $track_qty = $registered_row['COUNT_TRACK'];
                                                $date_created = $registered_row['DATECREATED'];
                                                $view =  '<a href="view-group.php?id='.$id.'" title="Update Status"><i class="fa fa-bars fa-2x"></i></a>';
