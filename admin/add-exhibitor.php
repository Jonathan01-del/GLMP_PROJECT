                ...
                <div class="col-md-12">
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <h3 class="panel-title">ADD EXHIBITOR :</h3>
                            <!-- <span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i></span> -->
                        </div>
                        <div class="panel-body">
                            <form name="myForm" method="POST" action="add_exh_submit.php" enctype="multipart/form-data" autocomplete="off">
                                <div class="card-body col-md-offset-1" align="left">
                                    <div class="form-group row">                                        
                                        <div class="col-md-3">
                                            <label for="exhibitor_name" class="text-primary">EXHIBITOR NAME:</label>
                                            <input type="text" id="exhibitor_name" style="text-transform: uppercase" class="form-control" name="exhibitor_name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="button" class="btn btn-danger btn-m text-uppercase" value="Cancel" onclick="window.location.href='index.php'" >
                                        </div>
                                    </div>  
                                </div>
                            </form>     
