...
// Query to get the Unpaid Delegate
    ...
    t.TRACK_CODE,
    t.CNT,
    SUM(t.CNT * d.PACKAGE_AMOUNT *.12) AS VATS,
    SUM(t.CNT * d.PACKAGE_AMOUNT)  AS TOTAL
    FROM delegate AS d 
    INNER JOIN selected_track AS t ON d.ID = t.DELEGATE_ID 
    LEFT JOIN list_track as l ON t.TRACK_CODE = l.CODE
    WHERE  l.STATUS !='Free' AND d.STATUS='UNPAID'";
     $regs_res = $con->query($regs_qry);
     $regs_row = $regs_res->fetch_assoc();
     $regs_vat = $regs_row['VATS'];
     $regs_srp = $regs_row['TOTAL'];
     $regs_cnt = $regs_srp + $regs_vat;
// End
?>
<!doctype html>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>UN-PAID</h5>
                                <h2>Php &nbsp;<span class="counter">&nbsp; <?php echo $regs_cnt; ?></span> <span class="tuition-fees">Unpaid Delegate</span></h2>
...
<!--                     <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        ...
        <?php include 'parts/unpaid_table.php';?>
