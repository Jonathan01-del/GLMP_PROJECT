...
// Query to get the Paid Delegate
    ...
    WHERE  l.STATUS !='Free' AND d.STATUS='PAID'";
    $delegate_result = $con->query($registered_qry);
    $delegate_row = $delegate_result->fetch_assoc();
    $vat = $delegate_row['VATS'];
    $srp = $delegate_row['TOTAL'];
    $cnt_reg = $srp + $vat
// End
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>PAID</h5>
                                <h2>Php &nbsp;<span class="counter">&nbsp; <?php echo $cnt_reg; ?></span> <span class="tuition-fees">Paid Delegate</span></h2>
...
<!--                     <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        ...
        <?php include 'parts/paid_table.php';?>
